    ...
    <div className="min-h-screen bg-vyr-bg-primary px-5 pt-6 pb-28 safe-area-top safe-area-left safe-area-right">
      ...
      <div className="flex flex-col items-center mb-8">
        <StateRing
          ...
          stateLabel={hasData ? state.stateLabel : "---"}
          onTap={onScoreTap}
        />
        ...
        {!hasData && (
          <p className="mt-4 text-vyr-text-muted text-sm text-center px-8">
            Conecte um wearable para iniciar a leitura do seu estado cognitivo.
          </p>
        )}
      </div>

      {/* Conteúdo só aparece quando há dados reais */}
      {hasData && (
        <>
